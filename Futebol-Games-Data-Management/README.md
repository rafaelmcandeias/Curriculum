...
_Nota:_ Como os nomes longos são raros, as estruturas de dados utilizadas só deverão alocar a memória necessária para guardar as strings dadas.
...
2. Para executarem todos os testes de uma `pasta` com o _valgrind_ deverão executar
